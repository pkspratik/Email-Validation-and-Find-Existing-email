...
System.out.println("Please Enter Mail ");
	...
	public static void findEmailId(String ui) {  // this method use for find email id 
		...
		listofemp.add("employee1@gmail.com");
		listofemp.add("employee2@gmail.com");
		listofemp.add("employee3@gmail.com");
		listofemp.add("employee4@gmail.com");
		listofemp.add("employee5@gmail.com");
